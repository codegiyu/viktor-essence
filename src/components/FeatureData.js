export const Data = [
  {
    id: 1,
    icon: "https://webstockreview.net/images/community-clipart-community-circle-13.png",
    header: "Community Support",
    info: "Essence comprises of a well-built experienced team which \
    is backed by the massive Support of a good community, working together \
    to ensure that the set goals and success level is attained. Great impact \
    to the outside world is certain because we work with great passion for \
    great things.",
  },
  {
    id: 2,
